...
RSpec.describe 'Merchant Dashboard Show Page' do
  describe 'Merchant Dashboard Show Page' do
    ...
    let!(:bulk_discountA) { create :bulk_discount, { merchant_id: merchant1.id, quantity: 10, percentage: .20 }  }
    let!(:bulk_discountB) { create :bulk_discount, { merchant_id: merchant1.id, quantity: 15, percentage: .30 }  }
